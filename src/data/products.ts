...
export const PRODUCTS: Product[] = [
  {
    ...
    description: 'Características: Mecanismo de cuarzo, acero inoxidable, resistente al agua, cristal mineral antirrayaduras, fechero y día de la semana 100% funcional. Recibimos a tasa BCV, envío gratis a nivel nacional a través de MRW.',
  ...
  },
  {
    ...
    description: 'Características: Mecanismo de cuarzo, acero inoxidable, resistente al agua, cristal mineral antirrayaduras, fechero y día de la semana 100% funcional.',
  ...
  },
  {
    ...
    description: 'Acero inoxidable, Cristal mineral antirrayaduras. El complemento perfecto para la mujer moderna.',
    image: '/assets/catalog/poedagar-dama.webp',
    category: 'dama',
    price: '$40',
    priceNote: 'Tasa BCV',
    specs: ['Diseño Femenino', 'Acero Inoxidable', 'Cristal Mineral Antirrayaduras'],
  ...
  },
  {
    ...
    description: 'Acero inoxidable, Cristal mineral antirrayaduras. Incluye caja y envío gratis. Elegancia absoluta en Rose Gold.',
...
export const BRANDS = [
  { name: 'Poedagar', subtitle: 'Lujo Ejecutivo & Acero', badge: 'Top Ventas' },
  { name: 'Nibosi', subtitle: 'Diseño Suizo & Deportivo', badge: 'Elegancia' },
  { name: 'Pablo Raez', subtitle: 'Clásico Vintage & Minimalista', badge: 'Diario' },
  { name: 'Pagani Design', subtitle: 'Homenajes de Colección', badge: 'Automáticos' },
  { name: 'Curren', subtitle: 'Cronógrafos de Alta Presencia', badge: 'Deportivo' },
];
